            ...
            <div className="product-single-l">
                <div className="product-img">
                    ...
                    <div className="product-img-thumbs flex align-center my-2">
                        ...
                        {product?.listProductVariant[0]?.image && <div className="thumb-item">
                            <img
                                src={product ? (product.image ? product?.listProductVariant[0]?.image : '') : ''}
                                alt=""
                                className="img-cover"
                            />
                        </div>}
                        {product?.listProductVariant[1]?.image && <div className="thumb-item">
                            <img
                                src={product ? (product.image ? product?.listProductVariant[1]?.image : '') : ''}
                                alt=""
                                className="img-cover"
                            />
                        </div>}
                        {product?.listProductVariant[2]?.image && <div className="thumb-item">
                            <img
                                src={product ? (product.image ? product?.listProductVariant[2]?.image : '') : ''}
                                alt=""
                                className="img-cover"
                            />
                        </div>}
                ...
                <div className="product-details font-manrope">
                    ...
                    <div className="price">
                        <div className="flex align-center">
                            <div className="old-price text-gray">{formatMoney(product?.price, {
                                groupSeparator: ',',
                                decimalSeparator: '.',
                                currentcy: 'đ',
